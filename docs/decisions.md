...
- **Test 11 follow-up pending (~2026-04-17/18 AEST):** verify lifecycle rule did NOT delete `worm-test/2026/04/16/2026-04-16T04-27-03Z_lifecycle-check.eml` (2-day COMPLIANCE lock; sandbox bucket has a 1-day lifecycle expire rule on `worm-test/` prefix — Object Lock must block it).
